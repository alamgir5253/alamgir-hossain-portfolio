...
const ContactMe = () => {
  return (
    <section className='contact-section'>
      <h2 className='text-2xl contact-title pt-10 text-center pb-20  text-slate-400 md:text-4xl'>Contact Me</h2>
      <div className="contact-body grid md:grid-cols-2  grid-cols-1">
        <div className="address-part h-full">
          ...
          <div className="address flex justify-start items-center">
            <div><AiFillFacebook className='contact-icon'/></div>
            <div><h4>facebook</h4>
            <p>https://www.facebook.com/alamgir5253</p></div>
